...
from provided_code.analysis_data_prep import summarize_scores, save_score_summary, consolidate_data_for_analysis, \
    make_criteria_satisfaction_df, make_criteria_satisfaction_summary, summarize_objective_weights, \
    summarize_solve_time_distribution, make_meta_data_table
from provided_code.plotting import make_dvh_metric_diff_plots, make_opt_error, make_criteria_satisfaction_plots, \
    plot_weight_norms
import os
...
if __name__ == '__main__':
    ...
    df_dose_error, df_dvh_metrics, df_clinical_criteria, df_ref_dvh_metrics, df_ref_clinical_criteria, df_objective_data, df_solve_time = \
        consolidate_data_for_analysis(cs,
                                      force_new_consolidate=False  # Set to true after generating new plans
                                      )
